    ...
    <div class="right-container">
            <table class="list" style="width:1100px; margin-top:40px;">
              ...
              <tr>
                ...
                <td>계정관리</td>
                <td>1.1.2</td>
                <td>검토절차의 수립 및 이에 따른 필수디지털자산 계정의 불법적인 사용 및 변경 여부에 대해 주기적 검토를 하고 있는가?(최소 분기 1회)</td>
                <td>중</td>
              </tr>
              <tr>
                <td style="width:50px;">1.1</td>
              ...
              <tr>
                ...
                <td>접근권한</td>
                <td>1.2.4</td>
                <td>시스템에 악영향을 미치는 기능을 정의 및 문서화하고, 동 기능에 대한 접근은 두 명의 관리자에게 승인받도록 조치하고 있는가?</td>
                <td>중</td>
              </tr>
              <tr>
                <td style="width:50px;">1.2</td>

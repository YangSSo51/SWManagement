...
<%@ include file="../navbar.jsp"%>
	<div class="right-container">
            ...
            <div class="tab-group">
              <a href="<c:url value="/asset/purchase/read/2"/>"><button type="button" name="button" class="white" >최신순</button></a>
              <a href="<c:url value="/asset/purchase/read/1"/>"><button type="button" name="button" style="margin-left:-5px;">오래된 순</button></a>
            </div>
            <hr>
